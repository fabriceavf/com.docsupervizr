        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <form-wizard :subtitle="null" :title="null" back-button-text="Precedent" class="mb-3 formUsers"
                    ...
                    <tab-content :before-change="validationForm" title="Information personnel">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label>nom </label>
                                <input v-model="form.nom" :disabled="isDisabled('form.nom')"
                                    :class="errors.nom ? 'form-control is-invalid' : 'form-control'" type="text">
                            ...
                            <div class="form-group col-sm-6">
                                <label>prenom </label>
                                <input v-model="form.prenom" :disabled="isDisabled('form.prenom')"
                                    :class="errors.prenom ? 'form-control is-invalid' : 'form-control'" type="text">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-3 ">
                                <label>sexes </label>
                                <v-select v-model="form.sexe_id" :disabled="isDisabled('form.sexe_id')" :options="sexesData"
                                    :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input v-model="form.date_naissance" :disabled="isDisabled('form.date_naissance')"
                                    :class="errors.date_naissance ? 'form-control is-invalid' : 'form-control'" type="date">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <v-select v-model="form.nationalite_id" :disabled="isDisabled('form.nationalite_id')"
                                    :options="nationalitesData" :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input v-model="form.telephone1" :disabled="isDisabled('form.telephone1')"
                                    :class="errors.telephone1 ? 'form-control is-invalid' : 'form-control'" type="text">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input v-model="form.nombre_enfant" :disabled="isDisabled('form.nombre_enfant')"
                                    :class="errors.nombre_enfant ? 'form-control is-invalid' : 'form-control'" type="number">
                            ...
                            <div class="form-group  col-sm-3">
                                ...
                                <v-select v-model="form.matrimoniale_id" :disabled="isDisabled('form.matrimoniale_id')"
                                    :options="matrimonialesData" :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input v-model="form.num_cnss" :disabled="isDisabled('form.num_cnss')"
                                    :class="errors.num_cnss ? 'form-control is-invalid' : 'form-control'" type="text">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input v-model="form.num_cnamgs" :disabled="isDisabled('form.num_cnamgs')"
                                    :class="errors.num_cnamgs ? 'form-control is-invalid' : 'form-control'" type="text">
                    ...
                    <tab-content :before-change="validationForm" title="Informations Agents">

                        <div class="row">

                            <div class="form-group col-sm-6">
                                <label>matricule </label>
                                <input v-model="form.matricule" :disabled="isDisabled('form.matricule')"
                                    :class="errors.matricule ? 'form-control is-invalid' : 'form-control'" type="text">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input v-model="form.num_dossier" :disabled="isDisabled('form.num_dossier')"
                                    :class="errors.num_dossier ? 'form-control is-invalid' : 'form-control'" type="text">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input v-model="form.date_embauche" :disabled="isDisabled('form.date_embauche')"
                                    :class="errors.date_embauche ? 'form-control is-invalid' : 'form-control'" type="date">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <v-select v-model="form.contrat_id" :disabled="isDisabled('form.contrat_id')"
                                    :options="contratsData" :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <v-select v-model="form.direction_id" :disabled="isDisabled('form.direction_id')"
                                    :options="directionsData" :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <v-select v-model="form.fonction_id" :disabled="isDisabled('form.fonction_id')"
                                    :options="fonctionsData" :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <v-select v-model="form.faction_id" :disabled="isDisabled('form.faction_id')"
                                    :options="factionsData" :reduce="ele => ele.id" label="Selectlabel" />
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label>postes </label>
                                <v-select v-model="form.poste_id" :disabled="isDisabled('form.poste_id')"
                                    :getOptionLabel="data => getOptionsData(data)" :options="postesData"
                                    :reduce="ele => ele.id" />
                            ...
                            <div class="form-group col-sm-3">
                                <label>villes </label>
                                <v-select v-model="form.ville_id" :disabled="isDisabled('form.ville_id')"
                                    :options="villesData" :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-3">
                                <label>zones </label>
                                <v-select v-model="form.zone_id" :disabled="isDisabled('form.zone_id')" :options="zonesData"
                                    :reduce="ele => ele.id" label="Selectlabel" />
                        ...
                        <div class="row">
                            <div class="form-group col-sm-3">
                                ...
                                <v-select v-model="form.categorie_id" :disabled="isDisabled('form.categorie_id')"
                                    :options="categoriesData" :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <v-select v-model="form.echelon_id" :disabled="isDisabled('form.echelon_id')"
                                    :options="echelonsData" :reduce="ele => ele.id" label="Selectlabel" />
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input v-model="form.num_badge" :disabled="isDisabled('form.num_badge')"
                                    :class="errors.num_badge ? 'form-control is-invalid' : 'form-control'" type="text">
