  ...
  <div class="row">
    <b-modal :id="formId" :size="formWidth">
      <template #modal-title>
        <div v-if="formState=='Update' ">Update Users #{{ formData.id }}</div>
        <div v-if="formState=='Create' ">Create Users</div>
      </template>
...
export default {
  name: 'UsersView',
  components: {DataTable, AgGridTable, CreateUsers, EditUsers, DataModal, AgGridBtnClicked},
  data() {
