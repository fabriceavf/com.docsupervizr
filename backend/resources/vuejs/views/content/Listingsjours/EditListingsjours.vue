    ...
    <form @submit.prevent="EditLine()">
      <div class="mb-3">
        <div class="row">
          ...
          <div class="form-group col-sm-6">
            <label>date </label>
            <input v-model="form.date" :class="errors.date?'form-control is-invalid':'form-control'" disabled
                   type="date">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <button v-if="filterOnlyAbscent" class="btn btn-danger" style="width:100%">Listes des abscent</button>
            <button v-if="filterOnlyPresent" class="btn btn-success" style="width:100%">Listes des present</button>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12">
...
export default {
  ...
  components: {
    VSelect, Files, AgGridBtnClicked, ListingsTraitements, AgGridTable, AgGridSearch, StatisticCardVertical,
