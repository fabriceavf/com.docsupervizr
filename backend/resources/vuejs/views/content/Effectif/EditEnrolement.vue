      ...
      <div id="nav-home" aria-labelledby="nav-home-tab" class="tab-pane fade show active" role="tabpanel">
        <form class="container" @submit.prevent="saveForm()">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select v-model="form.sexe" class="form-control">
                    <option :selected="{selected: form.sexe == 'Masculin' }" value="Masculin">Masculin</option>
                    <option :selected="{selected: form.sexe == 'Feminin' }" value="Feminin">Feminin</option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select v-model="form.fonction_id" class="form-control">
                    <option v-for="fonction in this.fonctions" :key="fonction.id" :value="fonction.id">
                      {{ fonction.libelle }}
                    </option>
                  </select>
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select v-model="form.statut" class="form-control" required>
                    <option :selected="{selected: form.statut == 'En poste' }" value="En poste">En poste</option>
                    <option :selected="{selected: form.statut == 'Retraite' }" value="Retraite">Retraite</option>
                    <option :selected="{selected: form.statut == 'Fin contrat' }" value="Fin contrat">Fin contrat
                    </option>
                  </select>
                </div>
              </div>
          ...
          <div class="d-flex justify-content-between">
            ...
            <button v-if="form.actif === 0" class="btn btn-success" type="button" @click.prevent="validerEmploye()">
        ...
        <form class="my-3" @submit.prevent="saveDocument()">
          <div class="form-row">
            <div class="form-group col-6">
              <label>Fichier</label>
              <input ref="document" class="form-control" required type="file" v-on:change="onFileChange()">
            </div>
            <div class="form-group col-6">
              <label>Libelle</label>
