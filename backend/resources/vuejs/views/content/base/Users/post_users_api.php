...
$editor = Editor::inst($db, '001_users', 'id');

$tables = Arr::pluck(DB::select("SHOW FULL COLUMNS FROM 001_users"), 'Field');
...
// le champs add_by
$editor->Fields(Field::inst('add_by')
    ->validator(Validate::required(ValidateOptions::inst()->message('Ce champs est requis')))
    ->xss(true)
    ->set(false)
// ->get(false)
