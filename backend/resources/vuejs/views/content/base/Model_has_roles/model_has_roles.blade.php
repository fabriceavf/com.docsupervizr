...
@section('title','Gestion des roles des utilisateurs')
@section('content')
    <div class="container">
    ...
    <div class='container editor_enfant_box'>
        {{--        <H2>Manager les roles des users</H2>--}}
        <div id='app'>
            <div id='form'></div>
            <div id='app_vue' v-show='show_table'>
                <div class='tables'>
                    <table id='model_has_roles' class='display table table-striped' style='width:100%'>
                        <thead>
                        <tr>
                            <th></th>
                            <th>Utilisateur</th>
        ...
        <div id='customForm' class='row'>
            {{--        <div class='col-md-12' data-editor-template='role_id'></div>--}}
            ...
            mounted() {
                ...
                let editor = new $.fn.dataTable.Editor({
                    ...
                    fields: [
                        ...
                        {label: 'Utilisateurs :', name: 'model_id', type: "selectperso"},
                        // le champs model_id
                        {label: 'Roles :', name: 'role_id', type: "selectperso"},
                ...
                let table = $('#model_has_roles').DataTable({
                    ajax: {
                        url: 'Model_has_roles',
                        type: 'POST',
