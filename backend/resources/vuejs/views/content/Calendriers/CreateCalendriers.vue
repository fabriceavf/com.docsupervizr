    ...
    <form @submit.prevent="createLine()">
      <div class="mb-3">
        ...
        <div class="form-group">
          ...
          <input v-model="form.description" :class="errors.description?'form-control is-invalid':'form-control'"
                 type="text">
...
export default {
  ...
  methods: {
    createLine() {
      this.isLoading = true
      this.axios.post('/api/calendriers', this.form).then(response => {
