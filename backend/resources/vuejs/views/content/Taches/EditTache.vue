      ...
      <div class="mb-3">
        ...
        <div class="form-group">
          <div class="form-check">
            <input id="1" v-model="form.type" :checked="{ checked: form.type === 'Collecte' }" class="form-check-input"
                   type="radio"
                   value="Collecte">
          ...
          <div class="form-check">
            <input id="2" v-model="form.type" :checked="{ checked: form.type === 'Atelier' }" class="form-check-input"
                   type="radio"
                   value="Atelier">
