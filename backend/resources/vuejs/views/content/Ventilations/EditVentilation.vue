<template>
  <div :key="key">
    ...
    <b-overlay v-show="modal==1" :show="isLoading">
      ...
      <table>
        ...
        <tr v-for="programme in programmes" :key="`${allKey[programme.id]}`">
          ...
          <td>
            <ventilationsHs :agentsOccuper="agentsOccuper" :allPointages="getAllPointagesForProgrammes(programme)"
    ...
    <div v-show="modal==2" style="display: flex;flex-direction: column;gap:10px">
      ...
      <button id="backButton" class="btn btn-primary" @click="hideDetail()"><i class="fa-solid fa-backward"></i> Retour
      </button>
