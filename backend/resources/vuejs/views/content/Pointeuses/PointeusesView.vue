...
export default {
  name: 'PointeusesView',
  components: {DataTable, AgGridTable, CreatePointeuses, EditPointeuses, DataModal, AgGridBtnClicked},
  data() {
        ...
        [
          ...
          },
          {
            ...
            valueFormatter: params => {
              let retour = ''
              try {
                return params.data['recupere']['Selectlabel']
              } catch (e) {
            ...
            filterParams: {suppressAndOrCondition: true,
              ...
              values: params => {
                params.success(this.recuperesData);
              },
  ...
  methods: {
    ...
    getrecuperes() {
      this.axios.get('/api/recuperes').then((response) => {
        this.requette--
        if (this.requette == 0) {
          this.$store.commit('setIsLoading', false)
        }
        this.recuperesData = response.data
