  ...
  >
    ...
    >
      <component
        ...
        :key="layoutContentRenderer === 'layout-content-renderer-left' ? routeData.meta.navActiveLink || routeData.name : null"
      >
        <template
  ...
  mixins: [mixinLayoutHorizontal],
   computed: {$routeData:function(){let router = {meta:{}};try{router=window.routeData}catch (e) {};return router; },
    ...
    layoutContentRenderer() {
      const rendererType = this.routeData.meta.contentRenderer
