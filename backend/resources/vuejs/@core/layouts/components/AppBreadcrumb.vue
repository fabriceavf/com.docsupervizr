<template>
  <b-row
    v-if="routeData.meta.breadcrumb || routeData.meta.pageTitle"
      ...
      <b-row class="breadcrumbs-top">
        <b-col cols="12">
          <h2 class="content-header-title float-left pr-1 mb-0">
            {{ routeData.meta.pageTitle }}
          </h2>
          <div class="breadcrumb-wrapper" v-if="routeData.meta.breadcrumb">
            <b-breadcrumb>
              ...
              <b-breadcrumb-item
                v-for="item in routeData.meta.breadcrumb"
                :key="item.text"
                :active="item.active"
                :to="item.to"
              >
