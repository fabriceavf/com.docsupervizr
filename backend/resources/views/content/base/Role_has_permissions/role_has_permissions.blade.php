...
@section('title','role_has_permissions')
@section('content')
    <div class="container">
    ...
    <div class='container editor_enfant_box'>
        {{--        <H2>Ratacher des permissions a des roles</H2>--}}
        <div id='app'>
            <div id='form'></div>
            <div id='app_vue' v-show='show_table'>
                <div class='tables'>
                    <table id='role_has_permissions' class='display table table-striped' style='width:100%'>
                        <thead>
                        <tr>
                            <th></th>
                            <th>permission</th>
    ...
    <script>
        ...
        var app = new Vue({
            ...
            mounted() {
                ...
                $('#role_has_permissions').css('width', '100%')
                let editor = new $.fn.dataTable.Editor({
                    ...
                    fields: [
                        ...
                        {label: 'permission_id :', name: 'permission_id', type: "selectperso"},
                        // le champs role_id
                ...
                let table = $('#role_has_permissions').DataTable({
                    ajax: {
                        url: '{{url()->full()}}',
                        type: 'POST',
