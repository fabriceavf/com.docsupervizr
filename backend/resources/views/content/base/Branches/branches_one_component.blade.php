                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row index_one_buttons">
                                    ...
                                    <button class='btn btn-info text-dark '
                                            onclick="window.location.replace('{{$Branches->SignedImpressionUrl}}')"><i
                                            class='fas fa-print'></i> Imprimer
                                    </button>


                                    @can('update',$Branches)
                                        <button class="btn btn-secondary " id="branches-row-edit">
                                            <i class='fas fa-edit'></i> Editer
                                        </button>
                                    @endcan
                                    @can('delete',$Branches)
                                        <button class="btn btn-danger " id="branches-row-delete">
    ...
    let Branches_editor_{{$__internalId__}}_config = {
        ...
        fields: [
...

            {
                ...
                label: " {{!empty($branches_editorLabels['adn'])?$branches_editorLabels['adn']:'Adn'}}  :", name: "adn"
