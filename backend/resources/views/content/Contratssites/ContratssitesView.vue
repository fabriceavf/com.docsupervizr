...
export default {
    ...
    components: {DataTable, AgGridTable, CreateContratssites, EditContratssites, DataModal, AgGridBtnClicked},
    data() {
        ...
        return {
            ...
            formKey: 0,
            tableKey: 0,
            url: 'http://127.0.0.1:8000/api/contratssites-Aggrid',
            table: 'contratssites',
            contratsclientsData: [],
            prestationsData: [],
            sitesData: [],
    ...
    created() {
        this.url = this.axios.defaults.baseURL + '/api/contratssites-Aggrid',
