...
export default {
    name: 'EditApprovisionementdetails',
    ...
    methods: {
        ...
        EditLine() {
            this.isLoading = true
            this.axios.post('/api/approvisionementdetails/' + this.form.id + '/update', this.form).then(response => {
        ...
        DeleteLine() {
            this.isLoading = true
            this.axios.post('/api/approvisionementdetails/' + this.form.id + '/delete').then(response => {
                this.isLoading = false
