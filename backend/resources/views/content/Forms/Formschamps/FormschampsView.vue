...
import ManageFormschamps from './ManageFormschamps.vue'
...
export default {
    ...
    components: {DataTable, AgGridTable, ManageFormschamps, DataModal, AgGridBtnClicked},
    data() {
    ...
    computed: {
        ...
        extrasData: function () {
            let params = {}
            params['id'] = {values: this.champsSelect, filterType: 'set'}
            return {
                'baseFilter': params,
            }
    ...
    methods: {
        ...
        showForm(type, data, gridApi, width = 'sm') {
            this.formKey++
