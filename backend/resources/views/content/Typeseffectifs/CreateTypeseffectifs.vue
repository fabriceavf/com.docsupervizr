            ...
            <div class="mb-3">
                ...
                <!-- <div class="row">
                    <div class="form-group col-sm">
                        ...
                        <input v-model="form.canCreate" @change="updateCheckboxValue('canCreate')"
                            :class="errors.canCreate ? 'form-control is-invalid' : 'form-control form-check-input'"
                            type="checkbox">
                    ...
                    <div class="form-group col-sm">
                        ...
                        <input v-model="form.canUpdate" @change="updateCheckboxValue('canUpdate')"
                            :class="errors.canUpdate ? 'form-control is-invalid' : 'form-control form-check-input'"
                            type="checkbox">
                    ...
                    <div class="form-group col-sm">
                        ...
                        <input v-model="form.canDelete" @change="updateCheckboxValue('canDelete')"
                            :class="errors.canDelete ? 'form-control is-invalid' : 'form-control form-check-input'"
                            type="checkbox">
...
export default {
    ...
    methods: {
        createLine() {
            ...
            this.axios.post('/api/typeseffectifs', this.form).then(response => {
