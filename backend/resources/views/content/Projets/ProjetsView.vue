                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>card_no </label>
                            <input id="cardNo" v-model="form.card_no"
...
export default {
    ...
    methods: {
        ...
        createLine() {
            ...
            this.form.punch_date = new Date().toISOString().slice(0, 10),
                this.form.punch_time = new Date().toISOString().slice(0, 19).replace('T', ' ')
            this.isLoading = true
