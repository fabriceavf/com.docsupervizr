<template>
    <b-overlay :show="isLoading">
        <form @submit.prevent="EditLine()">
            ...
            <div v-if="form.valider!='1'" class="d-flex justify-content-between">
...
import DetailsBesoins from "./DetailsBesoins.vue";
import Files from "@/components/Files.vue"
import VSelect from 'vue-select'

export default {
    name: 'EditBesoins',
    components: {VSelect, CustomSelect, Files, DetailsBesoins},
    ...
    methods: {
        ...
        EditLine() {
            this.isLoading = true
            this.axios.post('/api/besoins/' + this.form.id + '/update', this.form).then(response => {
        ...
        DeleteLine() {
            this.isLoading = true
            this.axios.post('/api/besoins/' + this.form.id + '/delete').then(response => {
                this.isLoading = false
