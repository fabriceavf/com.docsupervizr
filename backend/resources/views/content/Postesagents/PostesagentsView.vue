    ...
    <div class="row">
        <b-modal :id="formId" :size="formWidth">
            <template #modal-title>
                <div v-if="formState=='Update'">Update Postesagents #{{ formData.id }}</div>
...
export default {
    ...
    components: {DataTable, AgGridTable, CreatePostesagents, EditPostesagents, DataModal, AgGridBtnClicked},
    data() {
