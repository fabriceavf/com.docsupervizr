        ...
        <form v-if="step == 1" @submit.prevent="next()">
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input v-model="form.matricule" :class="{'is-invalid': errors.matricule }" _required
                           class="form-control"
                           type="text">
                </div>
                <div class="form-group col-md-6">
                    <label>Nom</label>
                    <input v-model="form.nom" :class="{'is-invalid': errors.nom }" _required class="form-control"
                           type="text">
                </div>
                <div class="form-group col-md-6">
                    <label>Prenom</label>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select v-model="form.fonction_id" :class="{'is-invalid': errors.fonction_id }"
                            class="form-control">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input v-model="form.telephone1" :class="{'is-invalid': errors.telephone1 }" class="form-control"
                           type="text">
                </div>
                <!--div class="form-group col-md-4">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input v-model="form.num_badge" :class="{'is-invalid': errors.num_badge }" class="form-control"
                           type="text">
                </div>
                <div class="form-group col-md-6">
                    <label>Code employé (Pointeuse)</label>
                    <input v-model="form.code_employe" :class="{'is-invalid': errors.code_employe }"
                ...
                <div class="col-md-6 row">
                    <div class="col-md-6">
                        <video id="webcam" autoplay playsinline
                               style="height: 50vh;width: 100%;object-fit: fill;"></video>
