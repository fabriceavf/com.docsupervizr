...
import CreatePreuves from './CreatePreuves.vue'
import EditPreuves from './EditPreuves.vue'
...
export default {
    name: 'PreuvesView',
    components: {DataTable, AgGridTable, CreatePreuves, EditPreuves, DataModal, AgGridBtnClicked},
    data() {
        ...
        return {
            ...
            formKey: 0,
            tableKey: 0,
            url: 'http://127.0.0.1:8000/api/preuves-Aggrid',
            table: 'preuves',
            programmesData: [],
            transactionsData: [],
            requette: 2,
    ...
    created() {
        this.url = this.axios.defaults.baseURL + '/api/preuves-Aggrid',
            ...
            [
                ...
                },
                {
                    ...
                    valueFormatter: params => {
                        let retour = ''
                        try {
                            return params.data['transaction']['Selectlabel']
                        } catch (e) {
                    ...
                    filterParams: {
                        ...
                        valueFormatter: params => params.value.Selectlabel,
                        values: params => {
                            params.success(this.transactionsData);
                        },
                        refreshValuesOnOpen: true,
                    },
                },
