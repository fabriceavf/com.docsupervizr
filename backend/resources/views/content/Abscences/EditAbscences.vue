<template>
    <b-overlay :show="isLoading">
        <form @submit.prevent="EditLine()">
            ...
            <div v-if="!form.valide" class="d-flex justify-content-between">
                <button class="btn btn-primary" type="submit">
                    <i class="fas fa-floppy-disk"></i> Mettre à jour
                </button>
                <button class="btn btn-primary" type="button" @click.prevent="valider()">
                    <i class="fas fa-close"></i> Valider l'abscence
                </button>
