    ...
    <b-overlay :show="isLoading">
        <form @submit.prevent="createLine()">
            <div class="mb-3">
                ...
                <div v-if="canShowFilter('plaque')" class="form-group">
                    <label>plaque </label>
                    <input v-model="form.plaque" class="form-control"
                           type="text">

                    <div v-if="errors.plaque" class='div-error' show variant="danger">
                        {{ errors.plaque }}
                    </div>
                </div>


                <div v-if="canShowFilter('capacite')" class="form-group">
                    <label>capacite </label>
                    <input v-model="form.capacite" class="form-control"
                           type="text">

                    <div v-if="errors.capacite" class='div-error' show variant="danger">
                        {{ errors.capacite }}
                    </div>
                </div>
