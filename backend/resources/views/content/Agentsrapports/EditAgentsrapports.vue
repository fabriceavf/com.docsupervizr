        ...
        <form @submit.prevent="EditLine()">
            <div class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <input v-model="form.jour_abscences"
                           :class="errors.jour_abscences?'form-control is-invalid':'form-control'"
                           type="text">

                    <div v-if="errors.jour_abscences" class="invalid-feedback">
                        <template v-for=" error in errors.jour_abscences"> {{ error[0] }}</template>
                ...
                <div class="form-group">
                    ...
                    <input v-model="form.jour_presences"
                           :class="errors.jour_presences?'form-control is-invalid':'form-control'"
                           type="text">

                    <div v-if="errors.jour_presences" class="invalid-feedback">
                        <template v-for=" error in errors.jour_presences"> {{ error[0] }}</template>
...
export default {
    ...
    methods: {
        ...
        EditLine() {
            this.isLoading = true
            this.axios.post('/api/agentsrapports/' + this.form.id + '/update', this.form).then(response => {
        ...
        DeleteLine() {
            this.isLoading = true
            this.axios.post('/api/agentsrapports/' + this.form.id + '/delete').then(response => {
                this.isLoading = false
