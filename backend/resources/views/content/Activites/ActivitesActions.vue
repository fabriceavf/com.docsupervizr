    ...
    <div class="activiteData">
        <div class="activiteParent">
            <div class="d-flex justify-content-between allBoutons">
                <button v-if="params.data.has_child" class="btn"><i class="fa-solid fa-sitemap"></i></button>
                <button v-else class="btn"><i class="fa-solid fa-eye-slash" style="opacity:0"></i></button>


                <button v-for="etape in steps" v-b-tooltip.hover :title="etape" class="btn" style="padding:0">

                    <i v-if="getFailStepState(etape)" class="fa-regular fa-circle-xmark" style="color:red"></i>
                    <i v-else-if="getSuccessStepState(etape)" class="fa-regular fa-circle-check"
                       style="color:green"></i>
                    <i v-else-if="getStartStepState(etape)" class="fa-regular fa-clock" style="color:#408cd7"></i>
            ...
            <div class="d-flex justify-content-between allBoutons">
                ...
                <div class="d-flex justify-content-between allBoutons">
                    ...
                    <div v-if="!params.data.validate" class="btn hideBouton"
                         style="height:100%;background:#2881a7;color:#fff;border-radius:5px;text-align:center;cursor:pointer;"
                         @click="updateElement"><i class="fa-solid fa-pen-to-square "></i> Aller
                    </div>
                    <div v-else class="btn  hideBouton"
                         style="height:100%;background:#2881a7;color:#fff;border-radius:5px;text-align:center;cursor:pointer;"
