    ...
    <b-overlay :show="isLoading">
        <form @submit.prevent="EditLine()">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <label>detail </label>
                    <input v-model="form.detail" :class="errors.detail?'form-control is-invalid':'form-control'"
                           type="text">

                    <div v-if="errors.detail" class="invalid-feedback">
                        <template v-for=" error in errors.detail"> {{ error[0] }}</template>
                ...
                <div class="form-group">
                    ...
                    <CustomSelect
                        :key="form.causeracine"
                        :columnDefs="['libelle']"
                        :oldValue="form.causeracine"
                        :renderCallBack="(data)=>`${data.Selectlabel}`"
                        :selectCallBack="(data)=>form.causeracine_id=data.id"
                        :url="`${axios.defaults.baseURL}/api/causeracines-Aggrid`"
                        filter-key=""
                        filter-value=""
                    />
                    <div v-if="errors.causeracine_id" class="invalid-feedback">
                        <template v-for=" error in errors.causeracine_id"> {{ error[0] }}</template>
                ...
                <div class="form-group">
                    ...
                    <CustomSelect
                        :key="form.mesurespreventive"
                        :columnDefs="['libelle']"
                        :oldValue="form.mesurespreventive"
                        :renderCallBack="(data)=>`${data.Selectlabel}`"
                        :selectCallBack="(data)=>form.mesurespreventive_id=data.id"
                        :url="`${axios.defaults.baseURL}/api/mesurespreventives-Aggrid`"
                        filter-key=""
                        filter-value=""
                    />
                    <div v-if="errors.mesurespreventive_id" class="invalid-feedback">
                        <template v-for=" error in errors.mesurespreventive_id"> {{ error[0] }}</template>
                ...
                <div class="form-group">
                    ...
                    <CustomSelect
                        :key="form.typeintervention"
                        :columnDefs="['libelle']"
                        :oldValue="form.typeintervention"
                        :renderCallBack="(data)=>`${data.Selectlabel}`"
                        :selectCallBack="(data)=>form.typeintervention_id=data.id"
                        :url="`${axios.defaults.baseURL}/api/typeinterventions-Aggrid`"
                        filter-key=""
                        filter-value=""
                    />
                    <div v-if="errors.typeintervention_id" class="invalid-feedback">
                        <template v-for=" error in errors.typeintervention_id"> {{ error[0] }}</template>
...
export default {
    ...
    methods: {
        ...
        EditLine() {
            this.isLoading = true
            this.axios.post('/api/interventions/' + this.form.id + '/update', this.form).then(response => {
        ...
        DeleteLine() {
            this.isLoading = true
            this.axios.post('/api/interventions/' + this.form.id + '/delete').then(response => {
                this.isLoading = false
