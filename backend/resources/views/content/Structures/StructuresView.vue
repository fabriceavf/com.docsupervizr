    ...
    <div class="row">
        <b-modal :id="formId" :size="formWidth">
            <template #modal-title >
                <div v-if="formState=='Update'">Update Structures #{{formData.id}}</div>
                <div v-if="formState=='Create'">Create Structures </div>
            </template>
...
<script>
    ...
    import CreateStructures from './CreateStructures.vue'
    import EditStructures from './EditStructures.vue'
    ...
    export default {
        name: 'StructuresView',
        components: {  DataTable,AgGridTable, CreateStructures, EditStructures, DataModal,AgGridBtnClicked,CustomSelect,CustomFiltre },
        data () {
            ...
            return {
                ...
                formKey:0,
                tableKey:0,
                url: 'http://127.0.0.1:8000/api/structures-Aggrid',
                table: 'structures',
                                requette: 0,
                columnDefs: null,
                rowData: null,
        ...
        created() {
            this.url= this.axios.defaults.baseURL+'/api/structures-Aggrid',
