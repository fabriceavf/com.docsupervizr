    ...
    <div class="row">
        <b-modal :id="formId" :size="formWidth">
            <template #modal-title >
                <div v-if="formState=='Update'">Update Technologies #{{formData.id}}</div>
                <div v-if="formState=='Create'">Create Technologies </div>
            </template>
...
<script>
    ...
    import CreateTechnologies from './CreateTechnologies.vue'
    import EditTechnologies from './EditTechnologies.vue'
    ...
    export default {
        ...
        components: {  DataTable,AgGridTable, CreateTechnologies, EditTechnologies, DataModal,AgGridBtnClicked,CustomSelect,CustomFiltre },
        data () {
            ...
            return {
                ...
                formKey:0,
                tableKey:0,
                url: 'http://127.0.0.1:8000/api/technologies-Aggrid',
                table: 'technologies',
                                requette: 0,
                columnDefs: null,
                rowData: null,
        ...
        created() {
            this.url= this.axios.defaults.baseURL+'/api/technologies-Aggrid',
