...
import CreateProgrammationsusers from './CreateProgrammationsusers.vue'
import EditProgrammationsusers from './EditProgrammationsusers.vue'
import DataModal from '@/components/DataModal.vue'

import AgGridBtnClicked from "@/components/AgGridBtnClicked.vue";

export default {
    name: 'ProgrammationsusersView',
    components: {
        DataTable,
        AgGridTable,
        CreateProgrammationsusers,
