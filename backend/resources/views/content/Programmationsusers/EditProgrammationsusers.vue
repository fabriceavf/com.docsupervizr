...
export default {
    ...
    methods: {
        ...
        EditLine() {
            this.isLoading = true
            this.axios.post('/api/programmationsusers/' + this.form.id + '/update', this.form).then(response => {
        ...
        DeleteLine() {
            this.isLoading = true
            this.axios.post('/api/programmationsusers/' + this.form.id + '/delete').then(response => {
                this.isLoading = false
