    ...
    <div class="row">
        <b-modal :id="formId" :size="formWidth">
            <template #modal-title >
                <div v-if="formState=='Update'">Update Architectures #{{formData.id}}</div>
                <div v-if="formState=='Create'">Create Architectures </div>
            </template>
...
<script>
    ...
    import CreateArchitectures from './CreateArchitectures.vue'
    ...
    export default {
        name: 'ArchitecturesView',
        components: {  DataTable,AgGridTable, CreateArchitectures, EditArchitectures, DataModal,AgGridBtnClicked,CustomSelect,CustomFiltre },
        data () {

            return {
                formId:"architectures",
                formState:"",
                formData:{},
                formWidth:'lg',
                formGridApi:{},
                formKey:0,
                tableKey:0,
                url: 'http://127.0.0.1:8000/api/architectures-Aggrid',
                table: 'architectures',
                                requette: 0,
                columnDefs: null,
                rowData: null,
        ...
        created() {
            this.url= this.axios.defaults.baseURL+'/api/architectures-Aggrid',
