...
import CreateDirections from './CreateDirections.vue'
import EditDirections from './EditDirections.vue'
...
export default {
    name: 'DirectionsView',
    components: {DataTable, AgGridTable, CreateDirections, EditDirections, DataModal, AgGridBtnClicked},
    data() {
        ...
        return {
            ...
            formKey: 0,
            tableKey: 0,
            url: 'http://127.0.0.1:8000/api/directions-Aggrid',
            table: 'directions',
            requette: 0,
            columnDefs: null,
            rowData: null,
    ...
    created() {
        this.url = this.axios.defaults.baseURL + '/api/directions-Aggrid',
