            ...
            <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="form-group  col-sm-3">
                        ...
                        <v-select
                            v-model="form.user"
                            :class="errors.user ? 'form-select is-invalid' : 'form-select'"
                            :options="usersData"
                            :reduce="ele => ele.id"
                            label="Selectlabel"
                        />
                    ...
                    <div class="form-group  col-sm-3">
                        ...
                        <v-select v-model="form.etats" :options="typeslistingData"/>
...
export default {
    ...
    components: {VSelect, CustomSelect, Files, AgGridTable},
    props: [
        'gridApi',
        'modalFormId',
        'actifsData',
    ...
    created() {
        if (this.$routeData.meta.listing == "automatique") {
