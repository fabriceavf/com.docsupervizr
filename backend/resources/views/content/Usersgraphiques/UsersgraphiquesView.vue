    ...
    <div class="row">
        <b-modal :id="formId" :size="formWidth">
            <template #modal-title>
                <div v-if="formState == 'Update'">Update Usersgraphiques #{{ formData.id }}</div>
                <div v-if="formState == 'Create'">Create Usersgraphiques</div>
            </template>

            <EditUsersgraphiques v-if="formState == 'Update'" :key="formKey" :data="formData"
...
import CreateUsersgraphiques from './CreateUsersgraphiques.vue'
import EditUsersgraphiques from './EditUsersgraphiques.vue'
...
export default {
    ...
    data() {
        ...
        return {
            ...
            formKey: 0,
            tableKey: 0,
            url: 'http://127.0.0.1:8000/api/usersgraphiques-Aggrid',
            table: 'usersgraphiques',
            graphiquesData: [],
            usersData: [],
            requette: 2,
            columnDefs: null,
    ...
    created() {
        this.url = this.axios.defaults.baseURL + '/api/usersgraphiques-Aggrid',
            (this.url2 = this.axios.defaults.baseURL + "/api/graphiques-Aggrid"),
    ...
    beforeMount() {
        this.columnDefs =
            [
                ...
                {
                    headerName: 'graphique',
                    field: 'graphique.Selectlabel',
                },
                {
                    ...
                    valueFormatter: params => {
                        let retour = ''
                        try {
                            return params.data['graphique']['Selectlabel']
                        } catch (e) {
                    ...
                    filter: "CustomFiltre",
                    filterParams: {
                        url: this.axios.defaults.baseURL + '/api/graphiques-Aggrid',
                        columnDefs: [
                            {
                                field: "",
                                sortable: true,
    ...
    methods: {
        ...
        addgraphique(data) {
            ...
            this.form.graphique_id = data.Selectvalue;
        ...
        deleteGraphique(data) {
            ...
            this.isLoading = true
            this.axios.post('/api/usersgraphiques/' + clickedDate + '/delete').then(response => {
                this.isLoading = false
        ...
        getgraphiques() {
            this.axios.get('/api/graphiques').then((response) => {
                this.requette--
                if (this.requette == 0) {
                    // this.$store.commit('setIsLoading', false)
                }
                this.graphiquesData = response.data
