...
class Programmation extends Model
{
    ...
    public static function boot()
    {
        ...
        self::creating(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammationObservers') &&
                method_exists('\App\Observers\ProgrammationObservers', 'creating')
            ) {

                try {
                    \App\Observers\ProgrammationObservers::creating($model);
        ...
        self::created(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammationObservers') &&
                method_exists('\App\Observers\ProgrammationObservers', 'created')
            ) {

                try {
                    \App\Observers\ProgrammationObservers::created($model);
        ...
        self::updating(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammationObservers') &&
                method_exists('\App\Observers\ProgrammationObservers', 'updating')
            ) {

                try {
                    \App\Observers\ProgrammationObservers::updating($model);
        ...
        self::updated(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammationObservers') &&
                method_exists('\App\Observers\ProgrammationObservers', 'updated')
            ) {

                try {
                    \App\Observers\ProgrammationObservers::updated($model);
        ...
        self::deleting(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammationObservers') &&
                method_exists('\App\Observers\ProgrammationObservers', 'deleting')
            ) {

                try {
                    \App\Observers\ProgrammationObservers::deleting($model);
        ...
        self::deleted(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammationObservers') &&
                method_exists('\App\Observers\ProgrammationObservers', 'deleted')
            ) {

                try {
                    \App\Observers\ProgrammationObservers::deleted($model);
    ...
    public function valideur2()
    {
        return $this->belongsTo(User::class, 'valideur_2', 'id');
    }

    public function valideur1()
    {
        return $this->belongsTo(User::class, 'valideur_1', 'id');
    }
    ...
    public function programmationsdetails()
    {
        return $this->hasMany(Programmationsdetail::class, 'programmation_id', 'id');
    }

    // public function programmationsusers()
    // {
    //     return $this->hasMany(Programmationsuser::class, 'programmation_id', 'id');
    // }

    public function programmes()
    {
        return $this->hasMany(Programme::class, 'programmation_id', 'id');
    }

    public function ventilations()
    {
        return $this->hasMany(Ventilation::class, 'programmation_id', 'id');
    }
