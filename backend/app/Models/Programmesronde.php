...
class Programmesronde extends Model
{
    ...
    public static function boot()
    {
        ...
        self::creating(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammesrondeObservers') &&
                method_exists('\App\Observers\ProgrammesrondeObservers', 'creating')
            ) {

                try {
                    \App\Observers\ProgrammesrondeObservers::creating($model);
        ...
        self::created(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammesrondeObservers') &&
                method_exists('\App\Observers\ProgrammesrondeObservers', 'created')
            ) {

                try {
                    \App\Observers\ProgrammesrondeObservers::created($model);
        ...
        self::updating(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammesrondeObservers') &&
                method_exists('\App\Observers\ProgrammesrondeObservers', 'updating')
            ) {

                try {
                    \App\Observers\ProgrammesrondeObservers::updating($model);
        ...
        self::updated(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammesrondeObservers') &&
                method_exists('\App\Observers\ProgrammesrondeObservers', 'updated')
            ) {

                try {
                    \App\Observers\ProgrammesrondeObservers::updated($model);
        ...
        self::deleting(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammesrondeObservers') &&
                method_exists('\App\Observers\ProgrammesrondeObservers', 'deleting')
            ) {

                try {
                    \App\Observers\ProgrammesrondeObservers::deleting($model);
        ...
        self::deleted(function ($model) {
            if (
                class_exists('\App\Observers\ProgrammesrondeObservers') &&
                method_exists('\App\Observers\ProgrammesrondeObservers', 'deleted')
            ) {

                try {
                    \App\Observers\ProgrammesrondeObservers::deleted($model);
    ...
    public function programmationsronde()
    {
        return $this->belongsTo(Programmationsronde::class, 'programmationsronde_id', 'id');
    }
    ...
    public function getProgrammationsrondeIdAttribute($value)
    {
        return $value;
    }

    public function setProgrammationsrondeIdAttribute($value)
    {
        $this->attributes['programmationsronde_id'] = $value ?? "";
    }
