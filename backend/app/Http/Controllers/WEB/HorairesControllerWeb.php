...
$id="Horaires_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page horaires Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les horaires")
){
abort(401);
}
...
$vue = view('/content/Horaires.Horaires', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les horaires")) {
abort(401);
}
...
$horaires_disposition->disposition=$request->get('disposition');
}
...
$vue = view('/content/Horaires.horaires_component', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'horaires_disposition'=>$horaires_disposition,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
$vue = view('/content/Horaires.Horaires', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'horaires_disposition'=>$horaires_disposition,'preselect'=>$new,'options'=>$donnees??[],
...
public function index_one(Request $request, Horaire $Horaires)
{
...
$vue = view('/content/Horaires.horaires_one', [
...
public function index_one_component(Request $request, Horaire $Horaires)
{
...
$vue = view('/content/Horaires.horaires_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Horaires' => $Horaires,
'horaires_disposition'=>$horaires_disposition
...
public function show_impression(Request $request, Horaire $Horaires)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Horaires.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Horaires' => $Horaires,
'horaires_disposition'=>$horaires_disposition
...
$this->HorairesRepository->show($id);
