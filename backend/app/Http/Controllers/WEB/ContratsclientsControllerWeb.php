...
$id="Contratsclients_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page contratsclients Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les contratsclients")
){
abort(401);
}
...
$vue = view('/content/Contratsclients.Contratsclients', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les contratsclients")) {
abort(401);
}
...
$contratsclients_disposition->disposition=$request->get('disposition');
}
...
public function index_one(Request $request, Contratsclient $Contratsclients)
{
...
$vue = view('/content/Contratsclients.contratsclients_one', [
...
public function index_one_component(Request $request, Contratsclient $Contratsclients)
{
...
$vue = view('/content/Contratsclients.contratsclients_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Contratsclients' => $Contratsclients,
'contratsclients_disposition'=>$contratsclients_disposition
...
public function show_impression(Request $request, Contratsclient $Contratsclients)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Contratsclients.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Contratsclients' => $Contratsclients,
'contratsclients_disposition'=>$contratsclients_disposition
...
$this->ContratsclientsRepository->show($id);
