...
$id="Works_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page works Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
$vue = view('/content/Works.Works', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les works")) {
abort(401);
}
...
$works_disposition->disposition=$request->get('disposition');
}
...
public function index_one(Request $request, Work $Works)
{
...
$vue = view('/content/Works.works_one', [
...
public function index_one_component(Request $request, Work $Works)
{
...
$vue = view('/content/Works.works_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Works' => $Works,
'works_disposition'=>$works_disposition
...
public function show_impression(Request $request, Work $Works)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Works.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Works' => $Works,
'works_disposition'=>$works_disposition
