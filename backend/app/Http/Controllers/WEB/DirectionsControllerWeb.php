...
$id="Directions_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page directions Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les directions")
){
abort(401);
}
...
$vue = view('/content/Directions.Directions', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les directions")) {
abort(401);
}
...
$directions_disposition->disposition=$request->get('disposition');
}
...
public function index_one(Request $request, Direction $Directions)
{
...
$vue = view('/content/Directions.directions_one', [
...
public function index_one_component(Request $request, Direction $Directions)
{
...
$vue = view('/content/Directions.directions_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Directions' => $Directions,
'directions_disposition'=>$directions_disposition
...
public function show_impression(Request $request, Direction $Directions)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Directions.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Directions' => $Directions,
'directions_disposition'=>$directions_disposition
...
$this->DirectionsRepository->show($id);
