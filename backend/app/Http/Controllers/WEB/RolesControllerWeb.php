...
class RolesControllerWeb extends Controller
{
...
$id="Roles_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page roles Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
$vue = view('/content/Roles.Roles', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les roles")) {
abort(401);
}
...
$roles_disposition->disposition=$request->get('disposition');
}
...
public function index_one(Request $request, Role $Roles)
{
...
$vue = view('/content/Roles.roles_one', [
...
public function index_one_component(Request $request, Role $Roles)
{
...
$vue = view('/content/Roles.roles_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Roles' => $Roles,
'roles_disposition'=>$roles_disposition
...
public function show_impression(Request $request, Role $Roles)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Roles.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Roles' => $Roles,
'roles_disposition'=>$roles_disposition
