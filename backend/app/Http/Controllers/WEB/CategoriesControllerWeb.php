...
class CategoriesControllerWeb extends Controller
{
...
$id="Categories_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page categories Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les categories")
){
abort(401);
}
...
$vue = view('/content/Categories.Categories', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les categories")) {
abort(401);
}
...
$categories_disposition->disposition=$request->get('disposition');
}
...
public function index_one(Request $request, Categorie $Categories)
{
...
$vue = view('/content/Categories.categories_one', [
...
public function index_one_component(Request $request, Categorie $Categories)
{
...
$vue = view('/content/Categories.categories_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Categories' => $Categories,
'categories_disposition'=>$categories_disposition
...
public function show_impression(Request $request, Categorie $Categories)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Categories.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Categories' => $Categories,
'categories_disposition'=>$categories_disposition
...
$this->CategoriesRepository->show($id);
