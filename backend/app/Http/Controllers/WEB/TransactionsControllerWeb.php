...
$id="Transactions_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page transactions Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les transactions")
){
abort(401);
}
...
$vue = view('/content/Transactions.Transactions', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les transactions")) {
abort(401);
}
...
$transactions_disposition->disposition=$request->get('disposition');
}
...
$vue = view('/content/Transactions.transactions_component', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'transactions_disposition'=>$transactions_disposition,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
$vue = view('/content/Transactions.Transactions', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'transactions_disposition'=>$transactions_disposition,'preselect'=>$new,'options'=>$donnees??[],
...
public function index_one(Request $request, Transaction $Transactions)
{
...
$vue = view('/content/Transactions.transactions_one', [
...
public function index_one_component(Request $request, Transaction $Transactions)
{
...
$vue = view('/content/Transactions.transactions_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Transactions' => $Transactions,
'transactions_disposition'=>$transactions_disposition
...
public function show_impression(Request $request, Transaction $Transactions)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Transactions.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Transactions' => $Transactions,
'transactions_disposition'=>$transactions_disposition
...
$this->TransactionsRepository->show($id);
