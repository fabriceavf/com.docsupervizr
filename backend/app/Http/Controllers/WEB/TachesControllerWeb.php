...
class TachesControllerWeb extends Controller
{
...
$id="Taches_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page taches Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
$vue = view('/content/Taches.Taches', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les taches")) {
abort(401);
}
...
$taches_disposition->disposition=$request->get('disposition');
}
...
$vue = view('/content/Taches.taches_component', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'taches_disposition'=>$taches_disposition,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
$vue = view('/content/Taches.Taches', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'taches_disposition'=>$taches_disposition,'preselect'=>$new,'options'=>$donnees??[],
...
public function index_one(Request $request, Tache $Taches)
{
...
$vue = view('/content/Taches.taches_one', [
...
public function index_one_component(Request $request, Tache $Taches)
{
...
$vue = view('/content/Taches.taches_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Taches' => $Taches,
'taches_disposition'=>$taches_disposition
...
public function show_impression(Request $request, Tache $Taches)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Taches.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Taches' => $Taches,
'taches_disposition'=>$taches_disposition
