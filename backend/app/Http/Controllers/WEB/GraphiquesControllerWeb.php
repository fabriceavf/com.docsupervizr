...
class GraphiquesControllerWeb extends Controller
{
...
$id="Graphiques_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page graphiques Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les graphiques")
){
abort(401);
}
...
$vue = view('/content/Graphiques.Graphiques', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les graphiques")) {
abort(401);
}
...
public function index_one(Request $request, Graphique $Graphiques)
{
...
$vue = view('/content/Graphiques.graphiques_one', [
...
public function index_one_component(Request $request, Graphique $Graphiques)
{
...
$vue = view('/content/Graphiques.graphiques_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Graphiques' => $Graphiques,
'graphiques_disposition'=>$graphiques_disposition
...
public function show_impression(Request $request, Graphique $Graphiques)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Graphiques.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Graphiques' => $Graphiques,
'graphiques_disposition'=>$graphiques_disposition
...
$this->GraphiquesRepository->show($id);
