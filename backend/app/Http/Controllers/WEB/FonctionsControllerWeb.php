...
$id="Fonctions_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page fonctions Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les fonctions")
){
abort(401);
}
...
$vue = view('/content/Fonctions.Fonctions', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les fonctions")) {
abort(401);
}
...
$fonctions_disposition->disposition=$request->get('disposition');
}
...
public function index_one(Request $request, Fonction $Fonctions)
{
...
$vue = view('/content/Fonctions.fonctions_one', [
...
public function index_one_component(Request $request, Fonction $Fonctions)
{
...
$vue = view('/content/Fonctions.fonctions_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Fonctions' => $Fonctions,
'fonctions_disposition'=>$fonctions_disposition
...
public function show_impression(Request $request, Fonction $Fonctions)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Fonctions.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Fonctions' => $Fonctions,
'fonctions_disposition'=>$fonctions_disposition
...
$this->FonctionsRepository->show($id);
