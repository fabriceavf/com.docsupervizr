...
$id="Sites_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page sites Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
$vue = view('/content/Sites.Sites', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les sites")) {
abort(401);
}
...
$sites_disposition->disposition=$request->get('disposition');
}
...
$vue = view('/content/Sites.sites_component', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'sites_disposition'=>$sites_disposition,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
$vue = view('/content/Sites.Sites', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'sites_disposition'=>$sites_disposition,'preselect'=>$new,'options'=>$donnees??[],
...
public function index_one(Request $request, Site $Sites)
{
...
$vue = view('/content/Sites.sites_one', [
...
public function index_one_component(Request $request, Site $Sites)
{
...
$vue = view('/content/Sites.sites_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Sites' => $Sites,
'sites_disposition'=>$sites_disposition
...
public function show_impression(Request $request, Site $Sites)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Sites.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Sites' => $Sites,
'sites_disposition'=>$sites_disposition
