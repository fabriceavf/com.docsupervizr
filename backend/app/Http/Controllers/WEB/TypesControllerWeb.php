...
class TypesControllerWeb extends Controller
{
...
$id="Types_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page types Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
$vue = view('/content/Types.Types', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les types")) {
abort(401);
}
...
$types_disposition->disposition=$request->get('disposition');
}
...
public function index_one(Request $request, Type $Types)
{
...
$vue = view('/content/Types.types_one', [
...
public function index_one_component(Request $request, Type $Types)
{
...
$vue = view('/content/Types.types_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Types' => $Types,
'types_disposition'=>$types_disposition
...
public function show_impression(Request $request, Type $Types)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Types.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Types' => $Types,
'types_disposition'=>$types_disposition
