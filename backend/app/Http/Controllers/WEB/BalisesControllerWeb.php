...
class BalisesControllerWeb extends Controller
{
...
$id="Balises_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page balises Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les balises")
){
abort(401);
}
...
$vue = view('/content/Balises.Balises', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les balises")) {
abort(401);
}
...
$balises_disposition->disposition=$request->get('disposition');
}
...
public function index_one(Request $request, Balise $Balises)
{
...
$vue = view('/content/Balises.balises_one', [
...
public function index_one_component(Request $request, Balise $Balises)
{
...
$vue = view('/content/Balises.balises_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Balises' => $Balises,
'balises_disposition'=>$balises_disposition
...
public function show_impression(Request $request, Balise $Balises)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Balises.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Balises' => $Balises,
'balises_disposition'=>$balises_disposition
...
$this->BalisesRepository->show($id);
