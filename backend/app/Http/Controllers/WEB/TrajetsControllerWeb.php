...
$id="Trajets_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page trajets Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les trajets")
){
abort(401);
}
...
$vue = view('/content/Trajets.Trajets', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les trajets")) {
abort(401);
}
...
public function index_one(Request $request, Trajet $Trajets)
{
...
$vue = view('/content/Trajets.trajets_one', [
...
public function index_one_component(Request $request, Trajet $Trajets)
{
...
$vue = view('/content/Trajets.trajets_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Trajets' => $Trajets,
'trajets_disposition'=>$trajets_disposition
...
public function show_impression(Request $request, Trajet $Trajets)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Trajets.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Trajets' => $Trajets,
'trajets_disposition'=>$trajets_disposition
...
$this->TrajetsRepository->show($id);
