...
class ProjetsControllerWeb extends Controller
{
...
$id="Projets_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page projets Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
&& !Auth::user()->can("Voir les projets")
){
abort(401);
}
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les projets")) {
abort(401);
}
...
public function index_one(Request $request, Projet $Projets)
{
...
$vue = view('/content/Projets.projets_one', [
...
public function index_one_component(Request $request, Projet $Projets)
{
...
$vue = view('/content/Projets.projets_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Projets' => $Projets,
'projets_disposition'=>$projets_disposition
...
public function show_impression(Request $request, Projet $Projets)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Projets.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Projets' => $Projets,
'projets_disposition'=>$projets_disposition
...
$this->ProjetsRepository->show($id);
