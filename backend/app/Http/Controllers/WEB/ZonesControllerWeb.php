...
$id="Zones_".Str::uuid()->toString().'_unique';
$id=Str::replace('-','_',$id);
...
'user_id' => Auth::id(),
'action' => 'Navigation vers page zones Reussi',
'ip' =>'Non defini',
'pays' =>'Non defini',
'ville' => 'Non defini',
...
$vue = view('/content/Zones.Zones', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature() && !Auth::user()->can("Voir les zones")) {
abort(401);
}
...
$zones_disposition->disposition=$request->get('disposition');
}
...
$vue = view('/content/Zones.zones_component', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'zones_disposition'=>$zones_disposition,'preselect'=>$new,'options'=>$donnees??[],'options'=>$donnees??[],
...
$vue = view('/content/Zones.Zones', ['pageConfigs' => $pageConfig, 'menu' => $this->menu,'zones_disposition'=>$zones_disposition,'preselect'=>$new,'options'=>$donnees??[],
...
public function index_one(Request $request, Zone $Zones)
{
...
$vue = view('/content/Zones.zones_one', [
...
public function index_one_component(Request $request, Zone $Zones)
{
...
$vue = view('/content/Zones.zones_one_component', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Zones' => $Zones,
'zones_disposition'=>$zones_disposition
...
public function show_impression(Request $request, Zone $Zones)
{
// La securite qui empeiche darriver sur cette sans avoir une signature valide
if (! $request->hasValidSignature()) {
abort(401);
...
$vue = view('/content/Zones.impression', [
'pageConfigs' => $pageConfig,
'editorData' => $request->All(),
'Zones' => $Zones,
'zones_disposition'=>$zones_disposition
