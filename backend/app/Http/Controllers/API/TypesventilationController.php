...
$data['creat_by']=Auth::id();
        ...
        if(!empty($data['identifiants_sadge'])){
            ...
            $Typesventilations->identifiants_sadge = $data['identifiants_sadge'];
...
$newCrudData=[];
                ...
                $newCrudData['creat_by']=$Typesventilations->creat_by;
                                $newCrudData['identifiants_sadge']=$Typesventilations->identifiants_sadge;
...
$oldCrudData=[];
                ...
                $oldCrudData['creat_by']=$Typesventilations->creat_by;
                                $oldCrudData['identifiants_sadge']=$Typesventilations->identifiants_sadge;
