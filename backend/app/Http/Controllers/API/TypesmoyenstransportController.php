...
$data['creat_by']=Auth::id();
        ...
        if(!empty($data['identifiants_sadge'])){
            ...
            $Typesmoyenstransports->identifiants_sadge = $data['identifiants_sadge'];
...
$newCrudData=[];
                ...
                $newCrudData['creat_by']=$Typesmoyenstransports->creat_by;
                                $newCrudData['identifiants_sadge']=$Typesmoyenstransports->identifiants_sadge;
...
$oldCrudData=[];
                ...
                $oldCrudData['creat_by']=$Typesmoyenstransports->creat_by;
                                $oldCrudData['identifiants_sadge']=$Typesmoyenstransports->identifiants_sadge;
