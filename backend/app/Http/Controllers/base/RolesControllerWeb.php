...
class RolesControllerWeb extends Controller
{
     ...
     * @param int $id
     */
    public function __construct(Request $request, RolesRepository $RolesRepository)
    {
    ...
    public function index()
    {
        ...
        $vue = view('/content/base/Roles.roles', ['pageConfigs' => $pageConfig, 'menu' => $this->menu]);
    ...
    public function post_index(Request $request)
    {
        ...
        $vue = view('/content/base/Roles.post_roles', ['editorData' => $request->All()]);
        return response($vue, 200);
    }
    ...
    public function create(Request $request)
    {
        ...
        //  dd($validated);
        //  $this->RolesRepository->create($validated);
    ...
    public function store(Request $request)
    {
        ...
        // $validated = $validator->validated();
        // dd($validated);
        // $this->RolesRepository->store($validated);
    ...
    public function update(Request $request, $id)
    {
        ...
        //    // Retrieve the validated input..
        //   $validated = $validator->validated();
        //   $this->RolesRepository->update($validated);
        //   dd($validated);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        //  $validated = $validator->validated();
        //  dd($validated);
        // $this->RolesRepository->destroy($validated);
