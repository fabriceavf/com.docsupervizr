...
class CreateAnalysespointeuseExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Analysespointeuses = new \App\Models\Analysespointeuse();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Analysespointeuses', 'entite_cle' => $Analysespointeuses->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
