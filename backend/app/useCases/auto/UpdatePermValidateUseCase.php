...
class UpdatePermValidateUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $agGrid = new \App\Http\AgGrid('perms', \App\Models\Perm::withoutGlobalScope(\Illuminate\Database\Eloquent\SoftDeletingScope::class));
