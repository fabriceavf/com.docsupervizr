...
class UpdateWebsocketsStatisticsEntrieExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $oldWebsockets_statistics_entries = $Websockets_statistics_entries->replicate();

        $oldCrudData = [];
        $oldCrudData['app_id'] = $oldWebsockets_statistics_entries->app_id;
        $oldCrudData['peak_connection_count'] = $oldWebsockets_statistics_entries->peak_connection_count;
        $oldCrudData['websocket_message_count'] = $oldWebsockets_statistics_entries->websocket_message_count;
        $oldCrudData['api_message_count'] = $oldWebsockets_statistics_entries->api_message_count;
        $oldCrudData['identifiants_sadge'] = $oldWebsockets_statistics_entries->identifiants_sadge;
        $oldCrudData['creat_by'] = $oldWebsockets_statistics_entries->creat_by;
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Update", 'entite' => 'Websockets_statistics_entries', 'entite_cle' => $Websockets_statistics_entries->id, 'ancien' => json_encode($oldCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
