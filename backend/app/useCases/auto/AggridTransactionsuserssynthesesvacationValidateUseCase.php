...
class AggridTransactionsuserssynthesesvacationValidateUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $query = \App\Models\Transactionsuserssynthesesvacation::withoutGlobalScope(SoftDeletingScope::class);
