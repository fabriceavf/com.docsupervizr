...
class CreateHoraireagentExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Horaireagents = new \App\Models\Horaireagent();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Horaireagents', 'entite_cle' => $Horaireagents->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
