...
class AggridDeploiementspointeusesmoyenstransportValidateUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $query = \App\Models\Deploiementspointeusesmoyenstransport::withoutGlobalScope(SoftDeletingScope::class);
