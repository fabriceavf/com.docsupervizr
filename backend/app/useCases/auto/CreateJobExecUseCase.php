...
class CreateJobExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Jobs', 'entite_cle' => $Jobs->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
