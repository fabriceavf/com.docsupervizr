...
class CreateUserbadgeExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Userbadges = new \App\Models\Userbadge();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Userbadges', 'entite_cle' => $Userbadges->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
