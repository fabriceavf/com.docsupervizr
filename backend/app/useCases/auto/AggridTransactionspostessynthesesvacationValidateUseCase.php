...
class AggridTransactionspostessynthesesvacationValidateUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $query = \App\Models\Transactionspostessynthesesvacation::withoutGlobalScope(SoftDeletingScope::class);
