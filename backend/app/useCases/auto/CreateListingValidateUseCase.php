...
class CreateListingValidateUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $agGrid = new \App\Http\AgGrid('listings', \App\Models\Listing::withoutGlobalScope(\Illuminate\Database\Eloquent\SoftDeletingScope::class));
