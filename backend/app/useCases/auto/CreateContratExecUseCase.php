...
class CreateContratExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Contrats = new \App\Models\Contrat();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Contrats', 'entite_cle' => $Contrats->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
