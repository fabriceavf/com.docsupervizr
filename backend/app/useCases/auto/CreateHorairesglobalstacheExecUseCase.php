...
class CreateHorairesglobalstacheExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Horairesglobalstaches = new \App\Models\Horairesglobalstache();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Horairesglobalstaches', 'entite_cle' => $Horairesglobalstaches->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
