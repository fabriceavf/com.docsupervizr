...
class CreateProgrammeExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Programmes = new \App\Models\Programme();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Programmes', 'entite_cle' => $Programmes->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
