...
class CreateDependanceExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Dependances = new \App\Models\Dependance();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Dependances', 'entite_cle' => $Dependances->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
