...
class CreateProgrammationsrondeExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Programmationsrondes = new \App\Models\Programmationsronde();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Programmationsrondes', 'entite_cle' => $Programmationsrondes->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
