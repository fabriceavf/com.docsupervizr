...
class CreateCategorieExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Categories = new \App\Models\Categorie();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Categories', 'entite_cle' => $Categories->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
