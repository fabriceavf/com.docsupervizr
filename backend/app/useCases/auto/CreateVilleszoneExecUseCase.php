...
class CreateVilleszoneExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Villeszones = new \App\Models\Villeszone();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Villeszones', 'entite_cle' => $Villeszones->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
