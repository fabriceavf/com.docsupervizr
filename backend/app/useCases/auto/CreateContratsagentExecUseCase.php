...
class CreateContratsagentExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Contratsagents = new \App\Models\Contratsagent();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Contratsagents', 'entite_cle' => $Contratsagents->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
