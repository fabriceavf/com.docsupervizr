...
class CreateCrudExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Cruds', 'entite_cle' => $Cruds->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
