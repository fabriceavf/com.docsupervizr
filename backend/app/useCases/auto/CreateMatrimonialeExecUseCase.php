...
class CreateMatrimonialeExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Matrimoniales = new \App\Models\Matrimoniale();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Matrimoniales', 'entite_cle' => $Matrimoniales->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
