...
class CreateListesjourExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Listesjours = new \App\Models\Listesjour();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Listesjours', 'entite_cle' => $Listesjours->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
