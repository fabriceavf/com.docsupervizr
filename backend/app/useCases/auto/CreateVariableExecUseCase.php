...
class CreateVariableExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Variables = new \App\Models\Variable();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Variables', 'entite_cle' => $Variables->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
