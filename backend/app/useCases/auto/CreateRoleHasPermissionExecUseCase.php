...
class CreateRoleHasPermissionExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Role_has_permissions = new \App\Models\RoleHasPermission();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Role_has_permissions', 'entite_cle' => $Role_has_permissions->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
