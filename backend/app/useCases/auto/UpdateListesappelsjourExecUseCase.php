...
class UpdateListesappelsjourExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $oldListesappelsjours = $Listesappelsjours->replicate();

        $oldCrudData = [];
        $oldCrudData['rand'] = $oldListesappelsjours->rand;
        $oldCrudData['jour01'] = $oldListesappelsjours->jour01;
        $oldCrudData['jour02'] = $oldListesappelsjours->jour02;
        $oldCrudData['jour03'] = $oldListesappelsjours->jour03;
        $oldCrudData['jour04'] = $oldListesappelsjours->jour04;
        $oldCrudData['jour05'] = $oldListesappelsjours->jour05;
        $oldCrudData['jour06'] = $oldListesappelsjours->jour06;
        $oldCrudData['jour07'] = $oldListesappelsjours->jour07;
        $oldCrudData['jour08'] = $oldListesappelsjours->jour08;
        $oldCrudData['jour09'] = $oldListesappelsjours->jour09;
        $oldCrudData['jour10'] = $oldListesappelsjours->jour10;
        $oldCrudData['jour11'] = $oldListesappelsjours->jour11;
        $oldCrudData['jour12'] = $oldListesappelsjours->jour12;
        $oldCrudData['jour13'] = $oldListesappelsjours->jour13;
        $oldCrudData['jour14'] = $oldListesappelsjours->jour14;
        $oldCrudData['jour15'] = $oldListesappelsjours->jour15;
        $oldCrudData['jour16'] = $oldListesappelsjours->jour16;
        $oldCrudData['jour17'] = $oldListesappelsjours->jour17;
        $oldCrudData['jour18'] = $oldListesappelsjours->jour18;
        $oldCrudData['jour19'] = $oldListesappelsjours->jour19;
        $oldCrudData['jour20'] = $oldListesappelsjours->jour20;
        $oldCrudData['jour21'] = $oldListesappelsjours->jour21;
        $oldCrudData['jour22'] = $oldListesappelsjours->jour22;
        $oldCrudData['jour23'] = $oldListesappelsjours->jour23;
        $oldCrudData['jour24'] = $oldListesappelsjours->jour24;
        $oldCrudData['jour25'] = $oldListesappelsjours->jour25;
        $oldCrudData['jour26'] = $oldListesappelsjours->jour26;
        $oldCrudData['jour27'] = $oldListesappelsjours->jour27;
        $oldCrudData['jour28'] = $oldListesappelsjours->jour28;
        $oldCrudData['jour29'] = $oldListesappelsjours->jour29;
        $oldCrudData['jour30'] = $oldListesappelsjours->jour30;
        $oldCrudData['jour31'] = $oldListesappelsjours->jour31;
        $oldCrudData['tache01'] = $oldListesappelsjours->tache01;
        $oldCrudData['tache02'] = $oldListesappelsjours->tache02;
        $oldCrudData['tache03'] = $oldListesappelsjours->tache03;
        $oldCrudData['tache04'] = $oldListesappelsjours->tache04;
        $oldCrudData['tache05'] = $oldListesappelsjours->tache05;
        $oldCrudData['tache06'] = $oldListesappelsjours->tache06;
        $oldCrudData['tache07'] = $oldListesappelsjours->tache07;
        $oldCrudData['tache08'] = $oldListesappelsjours->tache08;
        $oldCrudData['tache09'] = $oldListesappelsjours->tache09;
        $oldCrudData['tache10'] = $oldListesappelsjours->tache10;
        $oldCrudData['tache11'] = $oldListesappelsjours->tache11;
        $oldCrudData['tache12'] = $oldListesappelsjours->tache12;
        $oldCrudData['tache13'] = $oldListesappelsjours->tache13;
        $oldCrudData['tache14'] = $oldListesappelsjours->tache14;
        $oldCrudData['tache15'] = $oldListesappelsjours->tache15;
        $oldCrudData['tache16'] = $oldListesappelsjours->tache16;
        $oldCrudData['tache17'] = $oldListesappelsjours->tache17;
        $oldCrudData['tache18'] = $oldListesappelsjours->tache18;
        $oldCrudData['tache19'] = $oldListesappelsjours->tache19;
        $oldCrudData['tache20'] = $oldListesappelsjours->tache20;
        $oldCrudData['tache21'] = $oldListesappelsjours->tache21;
        $oldCrudData['tache22'] = $oldListesappelsjours->tache22;
        $oldCrudData['tache23'] = $oldListesappelsjours->tache23;
        $oldCrudData['tache24'] = $oldListesappelsjours->tache24;
        $oldCrudData['tache25'] = $oldListesappelsjours->tache25;
        $oldCrudData['tache26'] = $oldListesappelsjours->tache26;
        $oldCrudData['tache27'] = $oldListesappelsjours->tache27;
        $oldCrudData['tache28'] = $oldListesappelsjours->tache28;
        $oldCrudData['tache29'] = $oldListesappelsjours->tache29;
        $oldCrudData['tache30'] = $oldListesappelsjours->tache30;
        $oldCrudData['tache31'] = $oldListesappelsjours->tache31;
        $oldCrudData['listesappel_id'] = $oldListesappelsjours->listesappel_id;
        $oldCrudData['user_id'] = $oldListesappelsjours->user_id;
        $oldCrudData['identifiants_sadge'] = $oldListesappelsjours->identifiants_sadge;
        $oldCrudData['creat_by'] = $oldListesappelsjours->creat_by;
        try {
            $oldCrudData['listesappel'] = $oldListesappelsjours->listesappel->Selectlabel;
        } catch (\Throwable $e) {
        }
        try {
            $oldCrudData['user'] = $oldListesappelsjours->user->Selectlabel;
        } catch (\Throwable $e) {
        }
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Update", 'entite' => 'Listesappelsjours', 'entite_cle' => $Listesappelsjours->id, 'ancien' => json_encode($oldCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
