...
class CreateHistoriquemodelslistingExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Historiquemodelslistings = new \App\Models\Historiquemodelslisting();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Historiquemodelslistings', 'entite_cle' => $Historiquemodelslistings->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
