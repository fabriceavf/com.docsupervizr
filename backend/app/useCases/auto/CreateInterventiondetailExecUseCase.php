...
class CreateInterventiondetailExecUseCase
{
    ...
    public static function exec($data)
    {
        ...
        $Interventiondetails = new \App\Models\Interventiondetail();
        ...
        DB::table('cruds')->insert(['user_id' => Auth::id(), 'action' => "Create", 'entite' => 'Interventiondetails', 'entite_cle' => $Interventiondetails->id, 'ancien' => json_encode($newCrudData), 'nouveau' => json_encode($newCrudData), 'created_at' => now()]);
