...
GROUP BY programmes.date,users.matricule;";

        DB::statement('DROP VIEW IF EXISTS transactionsuserssynthesesvacations');
        DB::statement("CREATE VIEW transactionsuserssynthesesvacations AS $query");
     }catch (\Throwable $e){
