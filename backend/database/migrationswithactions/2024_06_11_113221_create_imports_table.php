...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createimports', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('import_id');

        });
        Schema::create('updateimports', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('import_id');

        });
        Schema::create('deleteimports', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('import_id');

        });
        Schema::create('readimports', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('import_id');
