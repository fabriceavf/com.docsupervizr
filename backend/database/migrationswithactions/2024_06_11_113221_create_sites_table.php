...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createsites', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('site_id');

        });
        Schema::create('updatesites', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('site_id');

        });
        Schema::create('deletesites', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('site_id');

        });
        Schema::create('readsites', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('site_id');
