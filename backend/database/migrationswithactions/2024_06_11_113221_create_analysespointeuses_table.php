...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createanalysespointeuses', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('analysespointeuse_id');

        });
        Schema::create('updateanalysespointeuses', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('analysespointeuse_id');

        });
        Schema::create('deleteanalysespointeuses', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('analysespointeuse_id');

        });
        Schema::create('readanalysespointeuses', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('analysespointeuse_id');
