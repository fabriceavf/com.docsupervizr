...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createmodelslistings', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('modelslisting_id');

        });
        Schema::create('updatemodelslistings', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('modelslisting_id');

        });
        Schema::create('deletemodelslistings', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('modelslisting_id');

        });
        Schema::create('readmodelslistings', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('modelslisting_id');
