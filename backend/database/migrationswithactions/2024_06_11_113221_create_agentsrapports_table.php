...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createagentsrapports', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('agentsrapport_id');

        });
        Schema::create('updateagentsrapports', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('agentsrapport_id');

        });
        Schema::create('deleteagentsrapports', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('agentsrapport_id');

        });
        Schema::create('readagentsrapports', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('agentsrapport_id');
