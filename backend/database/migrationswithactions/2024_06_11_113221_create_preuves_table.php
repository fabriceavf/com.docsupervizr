...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createpreuves', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('preuve_id');

        });
        Schema::create('updatepreuves', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('preuve_id');

        });
        Schema::create('deletepreuves', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('preuve_id');

        });
        Schema::create('readpreuves', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('preuve_id');
