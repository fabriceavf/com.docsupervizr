...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createtypesabscences', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('typesabscence_id');

        });
        Schema::create('updatetypesabscences', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('typesabscence_id');

        });
        Schema::create('deletetypesabscences', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('typesabscence_id');

        });
        Schema::create('readtypesabscences', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('typesabscence_id');
