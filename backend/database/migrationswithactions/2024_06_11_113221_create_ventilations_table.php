...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createventilations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('ventilation_id');

        });
        Schema::create('updateventilations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('ventilation_id');

        });
        Schema::create('deleteventilations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('ventilation_id');

        });
        Schema::create('readventilations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('ventilation_id');
