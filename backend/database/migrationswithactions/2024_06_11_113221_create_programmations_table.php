...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createprogrammations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('programmation_id');

        });
        Schema::create('updateprogrammations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('programmation_id');

        });
        Schema::create('deleteprogrammations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('programmation_id');

        });
        Schema::create('readprogrammations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('programmation_id');
