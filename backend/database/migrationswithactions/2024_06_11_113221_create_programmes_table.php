...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createprogrammes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('programme_id');

        });
        Schema::create('updateprogrammes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('programme_id');

        });
        Schema::create('deleteprogrammes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('programme_id');

        });
        Schema::create('readprogrammes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('programme_id');
