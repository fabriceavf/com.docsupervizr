...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('createabscences', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('abscence_id');

        });
        Schema::create('updateabscences', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('abscence_id');

        });
        Schema::create('deleteabscences', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('abscence_id');

        });
        Schema::create('readabscences', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('abscence_id');
