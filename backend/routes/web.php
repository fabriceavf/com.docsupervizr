...
//Route::resource('Architectures',App\Http\Controllers\WEB\ArchitecturesControllerWeb::class);
    Route::get('Architectures', [App\Http\Controllers\WEB\ArchitecturesControllerWeb::class, 'index'])->name('Architectures_web_index');


    Route::get('Architectures/show/{Architectures}', [App\Http\Controllers\WEB\ArchitecturesControllerWeb::class, 'index_one'])->name('Architectures_web_index_one');


//Route::resource('Assignations',App\Http\Controllers\WEB\AssignationsControllerWeb::class);
    Route::get('Assignations', [App\Http\Controllers\WEB\AssignationsControllerWeb::class, 'index'])->name('Assignations_web_index');


    Route::get('Assignations/show/{Assignations}', [App\Http\Controllers\WEB\AssignationsControllerWeb::class, 'index_one'])->name('Assignations_web_index_one');


//Route::resource('Backends',App\Http\Controllers\WEB\BackendsControllerWeb::class);
    Route::get('Backends', [App\Http\Controllers\WEB\BackendsControllerWeb::class, 'index'])->name('Backends_web_index');


    Route::get('Backends/show/{Backends}', [App\Http\Controllers\WEB\BackendsControllerWeb::class, 'index_one'])->name('Backends_web_index_one');
...
//Route::resource('Basesdedonnees',App\Http\Controllers\WEB\BasesdedonneesControllerWeb::class);
    Route::get('Basesdedonnees', [App\Http\Controllers\WEB\BasesdedonneesControllerWeb::class, 'index'])->name('Basesdedonnees_web_index');
...
//Route::resource('Besoinsfonctionels',App\Http\Controllers\WEB\BesoinsfonctionelsControllerWeb::class);
    Route::get('Besoinsfonctionels', [App\Http\Controllers\WEB\BesoinsfonctionelsControllerWeb::class, 'index'])->name('Besoinsfonctionels_web_index');


    Route::get('Besoinsfonctionels/show/{Besoinsfonctionels}', [App\Http\Controllers\WEB\BesoinsfonctionelsControllerWeb::class, 'index_one'])->name('Besoinsfonctionels_web_index_one');


//Route::resource('Besoinstechniques',App\Http\Controllers\WEB\BesoinstechniquesControllerWeb::class);
    Route::get('Besoinstechniques', [App\Http\Controllers\WEB\BesoinstechniquesControllerWeb::class, 'index'])->name('Besoinstechniques_web_index');


    Route::get('Besoinstechniques/show/{Besoinstechniques}', [App\Http\Controllers\WEB\BesoinstechniquesControllerWeb::class, 'index_one'])->name('Besoinstechniques_web_index_one');
...
//Route::resource('Headselements',App\Http\Controllers\WEB\HeadselementsControllerWeb::class);
    Route::get('Headselements', [App\Http\Controllers\WEB\HeadselementsControllerWeb::class, 'index'])->name('Headselements_web_index');


    Route::get('Headselements/show/{Headselements}', [App\Http\Controllers\WEB\HeadselementsControllerWeb::class, 'index_one'])->name('Headselements_web_index_one');
...
//Route::resource('Introductions',App\Http\Controllers\WEB\IntroductionsControllerWeb::class);
    Route::get('Introductions', [App\Http\Controllers\WEB\IntroductionsControllerWeb::class, 'index'])->name('Introductions_web_index');


    Route::get('Introductions/show/{Introductions}', [App\Http\Controllers\WEB\IntroductionsControllerWeb::class, 'index_one'])->name('Introductions_web_index_one');
...
//Route::resource('Postesarticles',App\Http\Controllers\WEB\PostesarticlesControllerWeb::class);
    Route::get('Postesarticles', [App\Http\Controllers\WEB\PostesarticlesControllerWeb::class, 'index'])->name('Postesarticles_web_index');


    Route::get('Postesarticles/show/{Postesarticles}', [App\Http\Controllers\WEB\PostesarticlesControllerWeb::class, 'index_one'])->name('Postesarticles_web_index_one');
...
//Route::resource('Traitements',App\Http\Controllers\WEB\TraitementsControllerWeb::class);
    Route::get('Traitements', [App\Http\Controllers\WEB\TraitementsControllerWeb::class, 'index'])->name('Traitements_web_index');


    Route::get('Traitements/show/{Traitements}', [App\Http\Controllers\WEB\TraitementsControllerWeb::class, 'index_one'])->name('Traitements_web_index_one');
...
//Route::resource('Typespointages',App\Http\Controllers\WEB\TypespointagesControllerWeb::class);
    Route::get('Typespointages', [App\Http\Controllers\WEB\TypespointagesControllerWeb::class, 'index'])->name('Typespointages_web_index');


    Route::get('Typespointages/show/{Typespointages}', [App\Http\Controllers\WEB\TypespointagesControllerWeb::class, 'index_one'])->name('Typespointages_web_index_one');
...
//Route::resource('Typesventilations',App\Http\Controllers\WEB\TypesventilationsControllerWeb::class);
    Route::get('Typesventilations', [App\Http\Controllers\WEB\TypesventilationsControllerWeb::class, 'index'])->name('Typesventilations_web_index');


    Route::get('Typesventilations/show/{Typesventilations}', [App\Http\Controllers\WEB\TypesventilationsControllerWeb::class, 'index_one'])->name('Typesventilations_web_index_one');
...
//Route::resource('Villeszones',App\Http\Controllers\WEB\VilleszonesControllerWeb::class);
    Route::get('Villeszones', [App\Http\Controllers\WEB\VilleszonesControllerWeb::class, 'index'])->name('Villeszones_web_index');


    Route::get('Villeszones/show/{Villeszones}', [App\Http\Controllers\WEB\VilleszonesControllerWeb::class, 'index_one'])->name('Villeszones_web_index_one');
...
//Route::resource('Contributions',App\Http\Controllers\WEB\ContributionsControllerWeb::class);
    Route::get('Contributions', [App\Http\Controllers\WEB\ContributionsControllerWeb::class, 'index'])->name('Contributions_web_index');


    Route::get('Contributions/show/{Contributions}', [App\Http\Controllers\WEB\ContributionsControllerWeb::class, 'index_one'])->name('Contributions_web_index_one');
...
//Route::resource('Deploiments',App\Http\Controllers\WEB\DeploimentsControllerWeb::class);
    Route::get('Deploiments', [App\Http\Controllers\WEB\DeploimentsControllerWeb::class, 'index'])->name('Deploiments_web_index');


    Route::get('Deploiments/show/{Deploiments}', [App\Http\Controllers\WEB\DeploimentsControllerWeb::class, 'index_one'])->name('Deploiments_web_index_one');
...
//Route::resource('Initialisations',App\Http\Controllers\WEB\InitialisationsControllerWeb::class);
    Route::get('Initialisations', [App\Http\Controllers\WEB\InitialisationsControllerWeb::class, 'index'])->name('Initialisations_web_index');


    Route::get('Initialisations/show/{Initialisations}', [App\Http\Controllers\WEB\InitialisationsControllerWeb::class, 'index_one'])->name('Initialisations_web_index_one');
...
//Route::resource('Structures',App\Http\Controllers\WEB\StructuresControllerWeb::class);
    Route::get('Structures', [App\Http\Controllers\WEB\StructuresControllerWeb::class, 'index'])->name('Structures_web_index');


    Route::get('Structures/show/{Structures}', [App\Http\Controllers\WEB\StructuresControllerWeb::class, 'index_one'])->name('Structures_web_index_one');
...
//Route::resource('Technologies',App\Http\Controllers\WEB\TechnologiesControllerWeb::class);
    Route::get('Technologies', [App\Http\Controllers\WEB\TechnologiesControllerWeb::class, 'index'])->name('Technologies_web_index');


    Route::get('Technologies/show/{Technologies}', [App\Http\Controllers\WEB\TechnologiesControllerWeb::class, 'index_one'])->name('Technologies_web_index_one');
